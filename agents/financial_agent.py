"""Financial Agent: инвестиции, недвижимость, карьера и wealth management."""
...
SYSTEM_PROMPT_PATH = PROJECT_ROOT / "agents" / "configs" / "financial_agent.md"
...
class FinancialAgent:
    """Агент личных финансов, инвестиций и wealth-стратегии для Романа."""
    ...
    def _load_system_prompt() -> str:
        """Загружает системный промпт из agents/configs/financial_agent.md."""
    ...
    def _build_system_message(self) -> str:
        """Объединяет системный промпт и профиль пользователя."""
    ...
    async def respond(self, user_message: str, history: list[Any]) -> str:
        ...
        try:
            ...
            console.print(f"[bold red]FinancialAgent LLM error:[/bold red] {exc}")
            raise
