"""Bio-Performance агент: OCR, бег, биохакинг и восстановление."""
...
SYSTEM_PROMPT_PATH = PROJECT_ROOT / "agents" / "configs" / "bio_agent.md"
...
class BioAgent:
    """Агент спортивной производительности и биохакинга для Романа."""
    ...
    def _load_system_prompt() -> str:
        """Загружает системный промпт из agents/configs/bio_agent.md."""
    ...
    async def respond(self, user_message: str, history: list[Any]) -> str:
        ...
        try:
            ...
            console.print(f"[bold red]BioAgent LLM error:[/bold red] {exc}")
            raise
